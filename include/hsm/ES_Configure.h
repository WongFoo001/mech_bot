...
#define EVENT_CHECK_HEADER "ToastEventChecker.h"

/****************************************************************************/
// This is the list of event checking functions
#define EVENT_CHECK_LIST ToastCheckBeacon, ToastCheckHall, ToastCheckUART
...
#define TIMER1_RESP_FUNC PostFloorTapeService          
#define TIMER2_RESP_FUNC PostFaceTapeService
#define TIMER3_RESP_FUNC PostWireService
#define TIMER4_RESP_FUNC PostToastHSM
#define TIMER5_RESP_FUNC PostToastHSM
#define TIMER6_RESP_FUNC TIMER_UNUSED 
#define TIMER7_RESP_FUNC PostToastHSM
#define TIMER8_RESP_FUNC PostToastHSM
#define TIMER9_RESP_FUNC TIMER_UNUSED
#define TIMER10_RESP_FUNC TIMER_UNUSED
#define TIMER11_RESP_FUNC TIMER_UNUSED
#define TIMER12_RESP_FUNC TIMER_UNUSED
#define TIMER13_RESP_FUNC PostToastHSM
#define TIMER14_RESP_FUNC PostToastHSM
#define TIMER15_RESP_FUNC PostToastHSM
...
#define BUMPER_SERVICE_TIMER 0
#define FLOOR_SERVICE_TIMER 1
#define FACE_TAPE_SERVICE_TIMER 2
#define WIRE_SERVICE_TIMER 3
#define FIND_WATCHDOG_TIMER 4
#define EXIT_VAT_TIMER 5
#define SOLVE_TIMER 6
#define FIND_TAPE_TIMER 7
#define MANEUVER_TIMER 8
#define HALL_BACKUP_TIMER 9
#define WIRE_BACKUP_TIMER 10
#define GP_SIT_AND_WAIT_TIMER 13
#define TT_SIT_AND_WAIT_TIMER 14
#define TF_SIT_AND_WAIT_TIMER 15
...
#if NUM_SERVICES > 1
// the header file with the public fuction prototypes
#define SERV_1_HEADER "Toast_HSM.h" // "Teensy_Service.h"
// the name of the Init function
#define SERV_1_INIT InitToastHSM // InitTeensyService
// the name of the run function
#define SERV_1_RUN RunToastHSM // RunTeensyService
...
#if NUM_SERVICES > 2
// the header file with the public fuction prototypes
#define SERV_2_HEADER "Toaster_Bumper_Service.h" // "toast_HSM.h"
// the name of the Init function
#define SERV_2_INIT InitBumperService // InitToastHSM
// the name of the run function
#define SERV_2_RUN RunBumperService //RunToastHSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public fuction prototypes
#define SERV_3_HEADER "wire_sense.h" 
// the name of the Init function
#define SERV_3_INIT InitWireService
// the name of the run function
#define SERV_3_RUN RunWireService 
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public fuction prototypes
#define SERV_4_HEADER "Floor_Tape_Service.h"
// the name of the Init function
#define SERV_4_INIT InitFloorTapeService
// the name of the run function
#define SERV_4_RUN RunFloorTapeService
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public fuction prototypes
#define SERV_5_HEADER "Face_Tape_Service.h"
// the name of the Init function
#define SERV_5_INIT InitFaceTapeService
// the name of the run function
#define SERV_5_RUN RunFaceTapeService
// How big should this services Queue be?
